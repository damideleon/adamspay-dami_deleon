...
.post("/", async (req, res, next) => {
    ...
    db.query("insert into venta(venta_id, cliente_id, venta_precio_total, venta_fecha_hora, venta_cobro, venta_estado, venta_cobro_estado, venta_cobrada_fechahora)" +
    "values "+
